      ...
      this.LocalTime = {
        ...
        getController: function () {
          return null != this.controller
            ? this.controller
            : (this.controller = new e.Controller());
        },
      };
    }).call(this);
  }).call(t);
  ...
  (function () {
    (function () {
          ...
          return (
            ...
            (e =
              ...
              (n =
                null !=
                (r =
                  null != (a = null != (i = t.matches) ? i : t.matchesSelector)
                    ? a
      ...
      function () {
        ...
        (t = e.config),
          (r = t.i18n),
          (e.getI18nValue = function (a, i) {
            var o, s;
            return (
              null == a && (a = ""),
              (o = (null != i ? i : { locale: t.locale }).locale),
              (s = n(r[o], a)),
              null != s
                ? s
                : o !== t.defaultLocale
                ? e.getI18nValue(a, { locale: t.defaultLocale })
                : void 0
            );
          }),
      ...
      function () {
        ...
        (t = e.getI18nValue),
          ...
          (e.strftime = a =
            function (e, o) {
              ...
              return (
                ...
                (l = e.getMinutes()),
                (h = e.getSeconds()),
                o.replace(/%(-?)([%aAbBcdeHIlmMpPSwyYZ])/g, function (o, m, p) {
                  switch (p) {
                    case "%":
                      return "%";
                    case "a":
          ...
          (r = function (t) {
            ...
            return (
              (i = t.toString()),
              (e = null != (n = i.match(/\(([\w\s]+)\)$/)) ? n[1] : void 0)
                ? /\s/.test(e)
                  ? e.match(/\b(\w)/g).join("")
                  : e
                : (e =
                    null != (r = i.match(/(\w{3,4})\s\d{4}$/)) ? r[1] : void 0)
                ? e
                : (e = null != (a = i.match(/(UTC[\+\-]\d+)/)) ? a[1] : void 0)
                ? e
                : ""
            );
          });
            ...
            return (
              (a.prototype.toString = function () {
                ...
                return (e = this.toTimeElapsedString())
                  ? r("time.elapsed", { time: e })
                  : (t = this.toWeekdayString())
                  ? ((e = this.toTimeString()),
                    r("datetime.at", { date: t, time: e }))
              ...
              (a.prototype.toTimeElapsedString = function () {
                var t, e, n, a, i;
                return (
                  (n = new Date().getTime() - this.date.getTime()),
                  (a = Math.round(n / 1e3)),
                  (e = Math.round(a / 60)),
                  (t = Math.round(e / 60)),
                  n < 0
                    ? null
                    : a < 10
                    ? ((i = r("time.second")), r("time.singular", { time: i }))
                    : a < 45
                    ? a + " " + r("time.seconds")
                    : a < 90
                    ? ((i = r("time.minute")), r("time.singular", { time: i }))
                    : e < 45
                    ? e + " " + r("time.minutes")
                    : e < 90
                    ? ((i = r("time.hour")), r("time.singularAn", { time: i }))
                    : t < 24
                    ? t + " " + r("time.hours")
                    : ""
                );
              ...
              (a.prototype.toDateString = function () {
                ...
                return (
                  (e = t(
                    this.calendarDate.occursThisYear()
            ...
            return (
              ...
              (e.prototype.observeWithMutationObserver = function () {
                ...
                if (
                  ...
                  return (
                    (t = new MutationObserver(this.processMutations)),
              ...
              (e.prototype.findSignificantElements = function (e) {
                ...
                return (
                  (n = []),
                  (null != e ? e.nodeType : void 0) === Node.ELEMENT_NODE &&
                    (t(e, this.selector) && n.push(e),
                    n.push.apply(n, e.querySelectorAll(this.selector))),
                  n
                );
              }),
                  ...
                  switch (((o = t[n]), o.type)) {
                    case "childList":
                      for (u = o.addedNodes, r = 0, i = u.length; r < i; r++)
                        (s = u[r]),
                          e.push.apply(e, this.findSignificantElements(s));
                  }
              ...
              (e.prototype.processInsertion = function (t) {
                var e;
                return (
                  (e = this.findSignificantElements(t.target)), this.notify(e)
                );
              }),
      ...
      function () {
        ...
        (r = e.parseDate),
          ...
          (e.Controller = (function () {
            function o() {
              (this.processElements = i(this.processElements, this)),
                (this.pageObserver = new e.PageObserver(
                  s,
            ...
            return (
              ...
              (o.prototype.startTimer = function () {
                var e;
                if ((e = t.timerInterval))
                  return null != this.timer
                    ? this.timer
                    : (this.timer = setInterval(this.processElements, e));
              }),
              (o.prototype.processElements = function (t) {
                var e, n, r;
                for (
                  null == t && (t = document.querySelectorAll(s)),
                    n = 0,
                    r = t.length;
                  n < r;
                  n++
              ...
              (o.prototype.processElement = function (t) {
                var e, i, o, s, l, d;
                if (
                  ((i = t.getAttribute("datetime")),
                  (o = t.getAttribute("data-format")),
                  (s = t.getAttribute("data-local")),
                  (l = r(i)),
                  !isNaN(l))
                )
                  return (
                    t.hasAttribute("title") ||
                      ((d = a(l, n("datetime.formats.default"))),
                      ...
                      (function () {
                        switch (s) {
                          ...
                          case "weekday-or-date":
                            return (
                              c(l).toWeekdayString() || c(l).toDateString()
                            );
                        }
                      })()),
